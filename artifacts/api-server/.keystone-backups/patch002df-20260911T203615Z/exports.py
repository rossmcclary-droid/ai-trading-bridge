...
async def export_ai_scan(
    ...
    if symbols:
        ...
        try:
            ...
            _quote_stats={"n_tasks":0,"wall_ms":0.0,"slowest_ms":0.0}
                ...
                async with _quote_semaphore:
                    try:
                        ...
                        if cached is not None:
                            ...
                            _quote_stats["n_tasks"]+=1; _quote_stats.setdefault("_started",time.perf_counter())
    ...
    _discovery_substage_ms.setdefault("quote_retrieval_gather_ms", 0.0)
    ...
    _quote_stats["wall_ms"]=(time.perf_counter()-_quote_stats.pop("_started",time.perf_counter()))*1000 if _quote_stats.get("n_tasks") else 0.0; _quote_stats["slowest_ms"]=_quote_stats["wall_ms"]/_quote_stats["n_tasks"] if _quote_stats.get("n_tasks") else 0.0
