...
async def _run_ai_scan_export_job(
    ...
    try:
        ...
        job_payload.setdefault("diagnostics", {})["patch002dj_timings"] = build_patch002dj(job, export_payload=job_payload.get("diagnostics", {}).get("patch002dj_timings_ms", {}))
        job.update(
            {
                "status": "READY",
                "filename": filename,
