...
def build_patch002dj(job, *, export_payload=None):
    ...
    top_sources = {
        ...
        "payload_assembly_serialization": measured("stage_5_payload_assembly", "payload_assembly", "payload_assembly_serialization"),
        "durable_result_write": job_measure("post_export_write_prepare_ms", "post_export_prepare_ms"),
        "durable_ready_transition": (delta("logical_complete", "ready_visible"), "clock.logical_complete_to_ready_visible"),
        "logical_complete_to_visible_ready": (None, None),
    }
    top_level = {
