...
async def export_ai_scan(
    ...
    timings_ms["stage_7_body_ms"] = round((_stage_7_body_finished - _timing_stage_started) * 1000, 3)
    ...
    timings_ms["response_json_dumps_ms"] = round((_response_json_finished - _response_json_started) * 1000, 3)
    _response_return_started = time.perf_counter()
    timings_ms["response_return_path_ms"] = round((_response_return_started - _stage_7_finished) * 1000, 3)
    return Response(
